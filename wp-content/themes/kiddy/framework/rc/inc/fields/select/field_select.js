...
(function( $ ) {
					...
					function() {
						...
						if ( $( this ).hasClass( 'font-icons' ) ) {
							default_params = $.extend(
								{}, {
									formatResult: redux.field_objects.select.addFaIcon,
									formatSelection: redux.field_objects.select.addFaIcon,
	...
	redux.field_objects.select.addFaIcon = function (icon) {
		if ( icon.hasOwnProperty( 'id' ) ) {
